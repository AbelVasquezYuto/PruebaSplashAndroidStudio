...
public class MainActivity_NavigationDrawer extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.main_activity__navigation_drawer, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
           fragmentManager.beginTransaction().replace(R.id.contenedor,new InicioFragment()).commit();
            ...
            fragmentManager.beginTransaction().replace(R.id.contenedor,new MisPublicacionesFragment()).commit();
